...
def mainModel(csv,img,mode):
    ...
    if mode == 3:
        ...
        print("ResNet     |", evScoreOwn[1])
        cv2.imshow("ResNet", imHolderOwn)
...
def runResnetKerasModel(trainX,testX,trainY,testY,mode):
    ...
    modelKeras.fit(trainX, trainY, epochs=epochNumber, validation_data=(testX, testY))
    ...
    modelKeras.save("pretrained/ResNet.h5")
...
def belongedClass(temp, testY, bipbop):
    ...
    top = [0, 9, 11, 12, 13, 14, 48, 60, 62, 63, 67, 72, 85, 86, 87, 88, 99, 120, 125, 130, 133, 147, 148, 149, 150, 152,
           163]
